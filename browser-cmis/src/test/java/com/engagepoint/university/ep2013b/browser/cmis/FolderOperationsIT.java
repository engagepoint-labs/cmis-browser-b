...
public class FolderOperationsIT {
    ...
    public void test1_create_folder_positive()
    {
        ...
        BrowserItem newItem = cmisBrowserService.findTreeById(item.getId());
    ...
    public void test3_edit_folder_positive()
    {
        ...
        BrowserItem item = cmisBrowserService.editFolder("117", "test_folder_AA", "cmis:folder");
    ...
    public void test5_delete_empty_folder()
    {
        ...
        cmisBrowserService.findTreeById("136");
    ...
    public void test7_delete_not_empty_folder()
    {
        ...
        cmisBrowserService.findTableById("108");
