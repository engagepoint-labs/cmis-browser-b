...
public class DocumentOperationsIT
{
	...
	public void test_createDocument()
	{
		...
		BrowserItem parent = service.findTableById("101");
	...
	//	@Ignore
	@Test
	public void test_editDocument_content() throws FileNotFoundException
	{
		// filename = "C:\Program Files\Java\jdk1.6.0_24\jre\Welcome.html"
		String filename = System.getProperty("java.home") + System.getProperty("file.separator") + "Welcome.html";
		...
		BrowserItem item = service.editDocument("139", "TestEditContent2Document", content);
		BrowserItem parent = service.findTableById("101");
		...
		assertEquals(4, parent.getChildren().size());
		assertEquals("TestEditContent2Document", item.getName());
		assertEquals(BrowserItem.TYPE.FILE, item.getType());
		assertFalse("".equals(item.getId()));
		assertEquals(16224, item.getSize().intValue());
		assertEquals("text/plain", item.getContentType());
	...
	public void test_editDocument()
	{
		...
		parent = service.findTableById("101");
		System.out.println("item   = " + item);
		System.out.println("parent = " + parent);
	...
	public void test_deleteDocument()
	{
		...
		parent = service.findTreeById("101");
		System.out.println("parent = " + parent);
	}
